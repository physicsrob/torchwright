"""Local-recency lobe frontier: how the plane cutoff trades window width W for
near-Δ resolution (docs/rope_port_plan.md Phase 6).

W = the largest distance at which a nearer key always outscores every farther
one, for the Hann-tapered mid-band lobe ``s(Δ) = Σ_p amp_p cos(Δ·θ_p)``.  Lower
...
print(
    f"Frontier (base={BASE:g}): lower theta_max widens W but kills near-Delta resolution."
)
