...
# identically).
CALCULATOR_MODULES = ["examples.calculator_simple", "examples.calculator_advanced"]


@pytest.fixture(scope="module", params=CALCULATOR_MODULES)
def calc_module(request):
    return importlib.import_module(request.param)


def _build(calc_module, digits):
